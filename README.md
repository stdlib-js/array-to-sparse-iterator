...
```javascript
sparsearray2iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-to-sparse-iterator@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-to-sparse-iterator@umd/bundle.js"></script>
```
